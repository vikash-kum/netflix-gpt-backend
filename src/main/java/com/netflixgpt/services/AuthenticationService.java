...
import com.netflixgpt.model.Token;
import com.netflixgpt.model.User;
import com.netflixgpt.repository.TokenRepository;
import com.netflixgpt.repository.UserRepository;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse authenticate(AuthenticationRequest request) {
    ...
    var user = userRepository.findByEmail(request.getEmail()).orElseThrow(() -> new NoSuchElementException("User not exists"));
